...
public class RestCalculator {
	...
	@RequestMapping(value = "/divCal/{customer}/{param1}/{param2}", method = RequestMethod.GET)
	public int div(@PathVariable String customer,@PathVariable int param1, @PathVariable int param2) throws Exception {
		try {
			// log mode
			log.debug("customer "+customer+" requested to divide");
			log.info("divide param 1:" + param1);
			log.warn("divide param 2:" + param2);
		return param1 / param2;
		}catch(Exception e) {
			log.error("john had error when trying to divide",e);
			throw e;
		}
	}
